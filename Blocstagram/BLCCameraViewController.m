...
@interface BLCCameraViewController () <CameraToolbarDelegate, ImageLibraryViewControllerDelegate>;
        ...
        [self.stillImageOutput captureStillImageAsynchronouslyFromConnection:videoConnection completionHandler: ^(CMSampleBufferRef imageSampleBuffer, NSError *error) {
            ...
            // #13
                        dispatch_async(dispatch_get_main_queue(), ^{
                                [self.delegate BLCCameraViewController:self didCompleteWithImage:image];
                            });
                    } else {
                            dispatch_async(dispatch_get_main_queue(), ^{
                                    ...
                                    [alertVC addAction:[UIAlertAction actionWithTitle:NSLocalizedString(@"OK", @"OK button") style:UIAlertActionStyleCancel handler:^(UIAlertAction *action) {
                                            [self.delegate BLCCameraViewController:self didCompleteWithImage:nil];
                                        }]];
